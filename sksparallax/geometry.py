...
def add_crosshairs (viewer, z_origin):
    ...
    cylinder_obj = VTKCylinderModel(height = 1, radius = 7.0,
          colour = (0.,1.,0.), name = "cylinder",
          angle = 90.0, orientation = (1.,0.,0.))
    ...
    #cylinder_obj.set_user_matrix(create_vtk_matrix_from_numpy(to_fp))
    ...
    viewer.vtk_overlay_window.add_vtk_models([cylinder_obj])
